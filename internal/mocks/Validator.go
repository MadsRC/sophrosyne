...
func (_c *Validator_Validate_Call) Run(run func(_a0 interface{})) *Validator_Validate_Call {
...
func (_c *Validator_Validate_Call) RunAndReturn(run func(interface{}) error) *Validator_Validate_Call {
	_c.Call.Return(run)
	return _c
}
